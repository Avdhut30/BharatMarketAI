# 📊 BharatMarketAI
#### APP Link: https://bharatmarketai-dbjdyybhwbmpuuj8bj5e4s.streamlit.app/
...
├── src/
│   ├── data/               # Market data (yfinance) & News scrapers
│   ├── features/           # TA-Lib indicators & Sentiment scoring
│   ├── models/             # XGBoost/LGBM training & walk-forward logic
│   ├── backtest/           # Core engine for bias-free performance evaluation
│   └── ui/                 # Business logic for the Advisor & Signals
├── reports/                # JSON/CSV outputs of backtests & configurations
├── data_cache/             # Locally cached market/news data (Speed optimized)
...
* Star ⭐ the repo
* Fork 🍴 and experiment
* Improve features or strategies
=======
### 📊 BharatMarketAI
